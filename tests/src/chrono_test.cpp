...
TEST_CASE("make_nanoseconds") {
  {
    ...
    REQUIRE(pqrs::osx::chrono::make_absolute_time_duration(ns) == absolute_time_duration);
  }
}
...
TEST_CASE("make_milliseconds") {
  {
    ...
    REQUIRE(pqrs::osx::chrono::make_absolute_time_duration(ms) == absolute_time_duration);
  }
}
